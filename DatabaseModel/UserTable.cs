...
namespace DatabaseModel
{
    ...
    public partial class UserTable
    {
        ...
        [Required(ErrorMessage = "Proszê wybraæ typ u¿ytkownika")]
        public int UserTypeID { get; set; }

        [Required(ErrorMessage = "Proszê wpisaæ login u¿ytkownika")]
        public string UserName { get; set; }

        [Required(ErrorMessage = "Proszê wpisaæ has³o u¿ytkownika")]
