...
namespace DatabaseModel
{
    ...
    public partial class EmployeeTable
    {
        ...
        [Required(ErrorMessage = "Proszê wpisaæ imiê i nazwisko pracownika")]
        public string FullName { get; set; }

        [Required(ErrorMessage = "Proszê wpisaæ imiê ojca pracownika")]
        public string FatherName { get; set; }

        [Required(ErrorMessage = "Proszê wpisaæ numer kontaktowy pracownika")]
        public string ContactNo { get; set; }

        [Required(ErrorMessage = "Proszê wpisaæ aemail pracownika")]
        public string Email { get; set; }

        [Required(ErrorMessage = "Proszê wpisaæ adres pracownika")]
        public string Address { get; set; }

        [Required(ErrorMessage = "Proszê wybraæ oznaczenie pracownika")]
        public int DesignationID { get; set; }

        [Required(ErrorMessage = "Proszê wybraæ dzia³ pracownika")]
